...
const PillNav = ({
  ...
  const cssVars = {
    ['--base']: baseColor,
    ['--nav-bg']: navBackground ?? baseColor,
    ['--pill-bg']: pillColor,
  ...
  return (
    <div className="fixed top-[1em] left-0 z-1000 w-full">
      <nav
        className={`mx-auto flex w-full items-center box-border px-4 md:w-max md:px-0 ${
          hasLogo ? 'justify-between md:justify-start' : 'justify-center'
        } ${className}`}
        aria-label="Primary"
        style={cssVars}
      >
      ...
      <div
        ...
        style={{
          ...cssVars,
          background: 'var(--nav-bg, var(--base, #f0f0f0))'
        }}
      >
